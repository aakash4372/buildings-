      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3">
            <img src='img/logo.jpg' alt="ddff" width={150}/>
            <p className=''>Boost your brand with our expert digital marketing strategies. Reach the right audience and grow your business online.</p>
          </div>
